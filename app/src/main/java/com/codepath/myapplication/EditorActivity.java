...
//                        mGender = EventEntry.GENDER_MALE;
//                    } else if (selection.equals(getString(R.string.gender_female))) {
//                        mGender = EventEntry.GENDER_FEMALE;
//                    } else {
//                        mGender = EventEntry.GENDER_UNKNOWN;
//                    }
//                }
//            }
//
...
//        values.put(EventEntry.COLUMN_EVENT_DESCRIPTION, breedString);
//        values.put(EventEntry.COLUMN_EVENT_URL, mGender);
//        values.put(EventEntry.COLUMN_EVENT_VENUE, weight);
//
