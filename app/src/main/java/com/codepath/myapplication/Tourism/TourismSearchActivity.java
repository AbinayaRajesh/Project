...
public class TourismSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new VenueCardAdapter(TourismSearchActivity.this, venues);
        // the recycler view
        rvTourism = (RecyclerView) findViewById(R.id.rvTourism);
        //resolve the recycler view and connect a layout manager and the adapter
        //rvMovies = (RecyclerView) findViewById(rvMovies);
        rvTourism.setLayoutManager(new GridLayoutManager(TourismSearchActivity.this, 2));
